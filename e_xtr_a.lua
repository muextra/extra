...
local Theee_xtr_a = io.open("Theee_xtr_a", 'w')
Theee_xtr_a:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 ee_xtr_a.lua
done
]])
Theee_xtr_a:close()
...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./Theee_xtr_a
done
]])
Run:close()
...
os.execute('chmod +x Theee_xtr_a;chmod +x Run;./Run')
end
...
Theee_xtr_a = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Theee_xtr_a)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Theee_xtr_a,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,5033962584,5555,5049866330}  
...
Status = 0
DevelopersQ = Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId) 
if UserId == 5033962584 then
Status = true
elseif UserId == 5555 then
Status = true
elseif UserId == 55555 then  
Status = true
elseif UserId == 555555 then
Status = true
...
Status = 0
Developers = Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5033962584 then
Status = '(المبرمج اكستراا)'
elseif UserId == 5555 then
Status = '#فـودیـگـا یـحـتـه'
elseif UserId == 55555 then
Status = '#مـسـتـر یـقـامـد'
elseif UserId == 555555 then
Status = '#عـسـلـیـه یـا وتـگـه'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == Theee_xtr_a then
Status = 'البوت'
elseif DevelopersQ then
Status = 'ثانوي'
elseif Developers then
Status = Redis:get(Theee_xtr_a.."ee_xtr_a:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(Theee_xtr_a.."ee_xtr_a:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Theee_xtr_a.."ee_xtr_a:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Theee_xtr_a.."ee_xtr_a:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Theee_xtr_a.."ee_xtr_a:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Theee_xtr_a.."ee_xtr_a:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Theee_xtr_a.."ee_xtr_a:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
MsgText = 'قامد التفاعل' 
elseif tonumber(Message) < 7000 then 
MsgText = 'غربله وربي 🌟' 
elseif tonumber(Message) < 9500 then 
MsgText = 'حزلقوم التفاعل تفاعل' 
...
return{
BanAll = Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨](https://t.me/ee_xtr_a)\n*┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄\n⧾ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⧾ خاصيه المسح *',
unLock   = '[𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨](https://t.me/ee_xtr_a)\n*┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄\n⧾ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨](https://t.me/ee_xtr_a)\n*┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄\n⧾ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⧾ خاصيه الكتم *',
lockKid  = '[𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨](https://t.me/ee_xtr_a)\n*┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄\n⧾ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⧾ خاصيه التقييد *',
lockKick = '[𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨](https://t.me/ee_xtr_a)\n*┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄\n⧾ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n⧾ خاصيه الطرد *',
Reply    = '[𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨](https://t.me/ee_xtr_a)\n*┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄\n⧾ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Theee_xtr_a).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(Theee_xtr_a..'ee_xtr_a:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(Theee_xtr_a) then
...
if tonumber(msg.sender.user_id) == 5033962584 then
msg.Name_Controller = '(المبرمج اكستراا)'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5555 then
msg.Name_Controller = '#فـودیـگـا_یـحـتـه'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Theee_xtr_a.."ee_xtr_a:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Theee_xtr_a.."ee_xtr_a:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي '
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Theee_xtr_a.."ee_xtr_a:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Theee_xtr_a.."ee_xtr_a:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Theee_xtr_a.."ee_xtr_a:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Theee_xtr_a.."ee_xtr_a:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Theee_xtr_a) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Theee_xtr_a.."ee_xtr_a:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Theee_xtr_a.."ee_xtr_a:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Theee_xtr_a) then
return false
end
local floods = Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Theee_xtr_a.."ee_xtr_a:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..msg_chat_id)
...
local Pin_Msg = Redis:get(Theee_xtr_a.."ee_xtr_a:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(Theee_xtr_a.."ee_xtr_a:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Theee_xtr_a) then
local N = (Redis:get(Theee_xtr_a.."ee_xtr_a:Name:Bot") or "نوفا")
photo = LuaTele.getUserProfilePhotos(Theee_xtr_a)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Theee_xtr_a.."ee_xtr_a:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Theee_xtr_a.."ee_xtr_a:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(Theee_xtr_a.."ee_xtr_a:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Theee_xtr_a.."ee_xtr_a:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Theee_xtr_a.."ee_xtr_a:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Theee_xtr_a.."ee_xtr_a:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Theee_xtr_a.."ee_xtr_a:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⧾ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Theee_xtr_a.."ee_xtr_a:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Theee_xtr_a.."ee_xtr_a:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⧾ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Theee_xtr_a.."ee_xtr_a:Command:List:Group"..msg_chat_id,text)
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Command:List:Group"..msg_chat_id,text)
Redis:del(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Theee_xtr_a.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Theee_xtr_a.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Theee_xtr_a.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Theee_xtr_a.."ee_xtr_a:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Theee_xtr_a.."ee_xtr_a:Group:Rules" .. msg_chat_id,text) 
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 

if text == "الغاء" then 
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(Theee_xtr_a.."ee_xtr_a:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم حفظ رد للمدير بنجاح \n⧾ ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Theee_xtr_a.."ee_xtr_a:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Theee_xtr_a.."ee_xtr_a:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Theee_xtr_a.."ee_xtr_a:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(Theee_xtr_a.."ee_xtr_a:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Theee_xtr_a.."ee_xtr_a:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Theee_xtr_a.."ee_xtr_a:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Theee_xtr_a.."ee_xtr_a:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Theee_xtr_a.."ee_xtr_a:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(Theee_xtr_a..'ee_xtr_a:'..v..text)
end
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Theee_xtr_a.."ee_xtr_a:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 

if text == "الغاء" or text == 'الغاء الامر ⧾' then   
Redis:del(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⧾ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theee_xtr_a.."ee_xtr_a:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⧾' then   
Redis:del(Theee_xtr_a.."ee_xtr_a:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⧾ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Theee_xtr_a..'ee_xtr_a:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⧾' then   
Redis:del(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⧾ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⧾' then   
Redis:del(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Theee_xtr_a.."ee_xtr_a:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⧾' then   
Redis:del(Theee_xtr_a.."ee_xtr_a:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Theee_xtr_a..'ee_xtr_a:GetTexting:DevTheee_xtr_a'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⧾' then 
Redis:del(Theee_xtr_a..'ee_xtr_a:GetTexting:DevTheee_xtr_a'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم الغاء حفظ كليشة المطور')
end
Redis:set(Theee_xtr_a..'ee_xtr_a:Texting:DevTheee_xtr_a',text)
Redis:del(Theee_xtr_a..'ee_xtr_a:GetTexting:DevTheee_xtr_a'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم حفظ كليشة المطور')
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⧾ تم الغاء امر تعين الايدي","md",true)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Theee_xtr_a.."ee_xtr_a:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Theee_xtr_a.."ee_xtr_a:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⧾' then   
Redis:del(Theee_xtr_a.."ee_xtr_a:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⧾ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Theee_xtr_a.."ee_xtr_a:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Theee_xtr_a.."ee_xtr_a:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⧾  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Theee_xtr_a.."ee_xtr_a:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⧾' then   
Redis:del(Theee_xtr_a.."ee_xtr_a:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⧾ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Theee_xtr_a.."ee_xtr_a:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Theee_xtr_a.."ee_xtr_a:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⧾  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Smile"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Smile"..msg.chat_id) then
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Smile"..msg.chat_id)
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Monotonous"..msg.chat_id) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Monotonous"..msg.chat_id)
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Riddles"..msg.chat_id) then
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Riddles"..msg.chat_id)
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Countrygof"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Countrygof"..msg.chat_id) then
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Countrygof"..msg.chat_id)
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Reflection"..msg.chat_id) then
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Reflection"..msg.chat_id)
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Theee_xtr_a.."ee_xtr_a:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Theee_xtr_a.."ee_xtr_a:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Theee_xtr_a.."ee_xtr_a:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Theee_xtr_a.."ee_xtr_a:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Difference"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Difference"..msg.chat_id) then 
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Difference"..msg.chat_id)
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Example"..msg.chat_id) then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:Game:Example"..msg.chat_id) then 
Redis:del(Theee_xtr_a.."ee_xtr_a:Game:Example"..msg.chat_id)
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text == 'رفع المشتركين' and msg.reply_to_message_id ~= 0 or text == 'رفع نسخه احتياطيه' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⧾ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Theee_xtr_a..'ee_xtr_a:Channel:Join')}, },}}
...
if tonumber(Theee_xtr_a) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Theee_xtr_a..'ee_xtr_a:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع النسخه' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⧾ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Theee_xtr_a) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم استرجاع المجموعات من نسخه جانكيز')
else
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ الملف لا يدعم هاذا البوت')
end
end
end
if (Redis:get(Theee_xtr_a..'ee_xtr_a:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⧾' then 
Redis:del(Theee_xtr_a..'ee_xtr_a:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,Theee_xtr_a).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⧾ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Theee_xtr_a..'ee_xtr_a:Channel:Join',ChannelUser) 
...
Redis:set(Theee_xtr_a..'ee_xtr_a:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Theee_xtr_a..'ee_xtr_a:Channel:Join')
...
--os.execute('rm -rf ee_xtr_a.lua')
--download('https://raw.githubusercontent.com/gackmm/shyco/master/ee_xtr_a.lua','ee_xtr_a.lua')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⧾ تم تحديث السورس * ',"md",true)  
end

Redis:del(Theee_xtr_a.."ee_xtr_a:AddSudosNew"..msg_chat_id)
if text and text:match("^@[%a%d_]+$") then
local UserId_Info = LuaTele.searchPublicChat(text)
if not UserId_Info.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⧾ عذرآ لا يوجد حساب بهاذا المعرف ","md",true)  
...
local Groups = Redis:smembers(Theee_xtr_a..'ee_xtr_a:ChekBotAdd')  
local UsersBot = Redis:smembers(Theee_xtr_a..'ee_xtr_a:Num:User:Pv')  
local Get_Json = '{"BotId": '..Theee_xtr_a..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..v)
local Constructor = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Originators:Group"..v)
local Manager = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Managers:Group"..v)
local Admin = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..v)
local Vips = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(Theee_xtr_a.."ee_xtr_a:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(Theee_xtr_a..'ee_xtr_a:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(Theee_xtr_a)
local mrt = LuaTele.getUser(Sudo_Id)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
break
end 
Groups = (Redis:scard(Theee_xtr_a..'ee_xtr_a:ChekBotAdd') or 0)
Users = (Redis:scard(Theee_xtr_a..'ee_xtr_a:Num:User:Pv') or 0)
if photo.total_count > 0 then
local ee_xtr_a = 'احصائيات الـــبوت'
...
{
{text = Grosupsw, url = 'https://t.me/ee_xtr_a'}, 
},
{
{text = Usperos, url = 'https://t.me/ee_xtr_a'}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(ee_xtr_a).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",msg_chat_id)
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Id"..msg_chat_id,true) ;Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Reply"..msg_chat_id,true) ;Redis:set(Theee_xtr_a.."ee_xtr_a:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Theee_xtr_a.."ee_xtr_a:Status:BanId"..msg_chat_id,true) ;Redis:set(Theee_xtr_a.."ee_xtr_a:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Theee_xtr_a.."ee_xtr_a:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",msg_chat_id) then
Redis:incr(Theee_xtr_a..'ee_xtr_a:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 

if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Theee_xtr_a.."ee_xtr_a:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {'اي يواد يخربيت امك 😂❤️',"يلهوي روح قلبي فلبيك يناس 🌚❤️","مش هتجيب مح بقق 🥺❤️","علطلاق خطفت قلبي يحته 🙈❤️","سيبك انت البيك ده جمد 🥺❤️",}
...
Get_Is_Id = Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Id:Groups") or Redis:get(Theee_xtr_a.."ee_xtr_a:Set:Id:Group"..msg_chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Theee_xtr_a.."ee_xtr_a:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Theee_xtr_a).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⧾ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Theee_xtr_a).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله ثانوي مسبق").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله ثانوي").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم تنزيله ثانوي مسبق").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم تنزيله ثانوي").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم تنزيله ثانوي مسبق").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم تنزيله ثانوي").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته ثانوي مسبقا").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته ثانوي").Reply,"md",true)  
end
end
if UserName[1] == "مطور" then
if not msg.DevelopersQ then
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Theee_xtr_a.."ee_xtr_a:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم ترقيته ثانوي مسبقا").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم ترقيته ثانوي").Reply,"md",true)  
end
end
if TextMsg == 'مطور' then
if not msg.DevelopersQ then
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم ترقيته ثانوي مسبقا").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم ترقيته ثانوي").Reply,"md",true)  
end
end
if UserId[1] == 'مطور' then
if not msg.DevelopersQ then
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⧾ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⧾ قائمه مطورين البوت \n ┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄*\n'
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Id"..msg_chat_id,true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:BotFree",true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Theee_xtr_a.."ee_xtr_a1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Theee_xtr_a.."ee_xtr_a1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Theee_xtr_a..'ee_xtr_a1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(Theee_xtr_a..'ee_xtr_a1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Theee_xtr_a..'ee_xtr_a1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Theee_xtr_a.."ee_xtr_a1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(Theee_xtr_a.."ee_xtr_a1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Theee_xtr_a.."ee_xtr_a1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Theee_xtr_a.."ee_xtr_a1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Theee_xtr_a.."ee_xtr_a1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Theee_xtr_a.."ee_xtr_a1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Theee_xtr_a.."ee_xtr_a1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Theee_xtr_a.."ee_xtr_a1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Theee_xtr_a.."ee_xtr_a11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Theee_xtr_a.."ee_xtr_a11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Theee_xtr_a.."ee_xtr_a11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(Theee_xtr_a..'ee_xtr_a11:Add:Rd:Sudo:Text'..text)
Redis:del(Theee_xtr_a..'ee_xtr_a11:Add:Rd:Sudo:Text1'..text)
Redis:del(Theee_xtr_a..'ee_xtr_a11:Add:Rd:Sudo:Text2'..text)
Redis:del(Theee_xtr_a.."ee_xtr_a11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Theee_xtr_a.."ee_xtr_a11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text"..v) 
Redis:del(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Theee_xtr_a.."ee_xtr_a11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Theee_xtr_a.."ee_xtr_a11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(Theee_xtr_a.."ee_xtr_a11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Theee_xtr_a.."ee_xtr_a11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Theee_xtr_a.."ee_xtr_a11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Theee_xtr_a.."ee_xtr_a11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:allM"..msg.chat_id, msg.id)
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Theee_xtr_a.."ee_xtr_a:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Theee_xtr_a.."ee_xtr_a:allM"..msg.chat_id)
...
Redis:del(Theee_xtr_a.."ee_xtr_a:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Theee_xtr_a.."ee_xtr_a:allM"..msg.chat_id)  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:Del:Media"..msg.chat_id)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:yt"..msg.chat_id)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم تفعيل اليوتيوب')
return false
end 

if text and text:match('^بحث (.*)$') and Redis:get(Theee_xtr_a.."ee_xtr_a:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'نزلني' then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:remMe"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم تعطيل نزلني ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:Welcome"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:Reply"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:BanId"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم تعطيل الرفع ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:KickMe"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم تعطيل اطردني ","md",true)
end
if TextMsg == 'قول' then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:kool"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:BotFree") 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:TwaslBot") 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾تم حظر الخنزير عام😹😹.").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Theee_xtr_a.."ee_xtr_a:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم حظر الخنزير من المجموعه 😹😹.").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم كتم الخنزير في المجموعه 😹😹.").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⧾تم طرد الخنزير من البار 😹😹. ").Reply,"md",true)  
end
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾تم حظر الخنزير عام من المجموعات 😹😹.").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾تم حظره من المجموعه برا يكلب 👉😂").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾تم كتم الخنزير فلبار😹😹.  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⧾ تم طرده من المجموعه برا يكلب 😹😹").Reply,"md",true)  
end
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾تم حظر الخنزير عام من المجموعات 😹😹.").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:BanAll:Groups",UserId) 
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم حظره من المجموعه برا يكلب 😹😹").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم الغاء حظره من المجموعه الصلح خير قلبك ابيض 🌚❤️").Reply,"md",true)  
end
end
...
if Redis:sismember(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم كتمه في المجموعه لو منك اخرج من البار 😹😹.").Reply,"md",true)  
end
end
...
if not Redis:sismember(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم الغاء كتمه من المجموعه الصلح خير قلبك ابيض 🌚💗.").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم الغاء تقييده من المجموعه الصلح خير قلبك ابيض 🌚💗.").Reply,"md",true)  
end
...
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⧾ تم طرده من المجموعه برا يكلب 😂👍🏾.").Reply,"md",true)  
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Status:KickMe"..msg_chat_id) then
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⧾معلسلامه متجيش تاني 😹😹.").Reply,"md",true)  
end

if text == "نزلني" then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text == 'رتبتي' then
local photo = LuaTele.getUserProfilePhotos(Theee_xtr_a)
local mrt = LuaTele.getUser(msg.sender.user_id)
local T = " رتبتك〉 "..Controller(msg_chat_id,msg.sender.user_id).." "
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' '..mrt.first_name..' ', url = "https://t.me/"..mrt.username}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(itsNova..'Nova:Channel:Join:Name')..'', url = 't.me/'..Redis:get(itsNova..'Nova:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local Info_Members = LuaTele.getSupergroupMembers(msg_chat_id, "Administrators", "*", 0, 200)
local List_Members = Info_Members.members
...
if photo.total_count > 0 then
local TestText = "‹ معلومات مالك الجروب ›\n\n‹ الاسم :› ["..UserInfo.first_name.."](tg://user?id="..UserInfo.id..")\n\n‹ البايو :› ["..Bio.."]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' '..os.date("%Y/%m/%d")..' ', url = "https://t.me/ee_xtr_a"}
},
}
...
if text == 'منشئ الجروب' or text == 'المنشئ' or text == 'المالك' then   
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if text == 'رونالدو' or text == 'اكستراا' or text == 'مبرمج السورس' or text == 'المبرمج اكستراا' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
LuaTele.sendText(5033962584,0,'*\n⧾ مرحباً عزيزي المبرمج اكستراا \n\n⧾ شخص ما يحتاج الي مساعده\n\n┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄\n\n⧾ اسمه :- '..klajq..' \n\n⧾ ايديه :-  : '..msg.sender.user_id..'\n\n⧾ - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
...
if not msg.ControllerBot and not Redis:set(Theee_xtr_a.."ee_xtr_a:LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⧾ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Theee_xtr_a.."ee_xtr_a:ch:admin")
...
local zwgat_list = Redis:smembers(ee_xtr_a..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(ee_xtr_a..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(ee_xtr_a..msg_chat_id.."mutlqat:")
...
local klbklb_list = Redis:smembers(ee_xtr_a..msg_chat_id.."klbklb:")
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:text"..msg_chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⧾ تم قفـل الدردشه لي كده ربنا يقفلها في وشك 😹😹.").Lock,"md",true)  
return false
end 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:AddMempar"..msg_chat_id,"kick")  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⧾ تم قفـل اضافة الاعضاء لي كده ربنا يقفلها ف وشك 😹😹.").Lock,"md",true)  
return false
end 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Join"..msg_chat_id,"kick")  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⧾ تم قفـل دخول الاعضاء لي كده ربنا يقفلها ف وشك 😹😹.").Lock,"md",true)  
return false
end 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Theee_xtr_a..'ee_xtr_a:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:text"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⧾ تم فتح الدردشه لووووووووو😹😹.").unLock,"md",true)  
return false
end 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Join"..msg_chat_id)  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:lockpin"..msg_chat_id)  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:edit"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Theee_xtr_a..'ee_xtr_a:'..lock..msg_chat_id)    
end
...
if text == "استوري قران" then
Rrr = math.random(4,50)
local m = "https://t.me/shdev1/"..Rrr..""
local t = "⧾ امسك يا واد يهقر 🌚 ❤️"
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
...
local Text ='*⧾ امسك يا واد يهقر 🌚 ❤️*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⧾ امسك يا واد يهقر 🌚 ❤️',url="t.me/ee_xtr_a"}},
}
local msg_id = msg.id/2097152/0.5
...
if text == "قران بالصوره" or text == "قران" then 
Abs = math.random(2,140); 
local Text ='*⧾ امسك يا واد يهقر 🌚 ❤️*'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '⧾ امسك يا واد يهقر 🌚 ❤️', url = "https://t.me/ee_xtr_a"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/shdev2/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/agklpoj/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:kool"..msg.chat_id) then
...
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Link"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Video"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:geam"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:vico"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:forward"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Document"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..msg_chat_id)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم مسح الرابط ","md",true)             
end

if text == "الرابط" then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Theee_xtr_a.."ee_xtr_a:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(Theee_xtr_a.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Welcome"..msg_chat_id) then
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ تم ازالة قوانين المجموعه","md",true)    
end

if text == "القوانين" then 
local Rules = Redis:get(Theee_xtr_a.."ee_xtr_a:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Theee_xtr_a.."ee_xtr_a:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Theee_xtr_a.."ee_xtr_a:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Theee_xtr_a..'ee_xtr_a:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⧾ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Theee_xtr_a.."ee_xtr_a:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨', url = 't.me/ee_xtr_a'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
if text and text:match('لقب (.*)') and msg.reply_to_message_id ~= 0 then
local Cu stomTitle = text:match('لقب (.*)')
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ᥀︙هاذا الامر يخص 『 '..Controller_Num(4)..' 』* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text and text:match('^لقب @(%S+) (.*)$') then
local UserName = {text:match('^لقب @(%S+) (.*)$')}
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ᥀︙هاذا الامر يخص 『 '..Controller_Num(4)..' 』* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:del(Theee_xtr_a..'ee_xtr_a:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Theee_xtr_a..'ee_xtr_a:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Theee_xtr_a..'ee_xtr_a:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⧾ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⧾ عدد رسائلك هنا *~ '..(Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⧾ عدد التعديلات هنا *~ '..(Redis:get(Theee_xtr_a..'ee_xtr_a:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⧾ عدد جهاتك المضافه هنا *~ '..(Redis:get(Theee_xtr_a.."ee_xtr_a:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⧾ ارسل الان النص
⧾ يمكنك اضافه :
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Id:Group"..msg.chat_id)
...
Redis:del(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups") 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Developers:Groups") 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Originators:Group"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Managers:Group"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:BanAll:Groups") 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..msg_chat_id) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Theee_xtr_a.."ee_xtr_a:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ✭"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Theee_xtr_a.."ee_xtr_a:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Gif"..v)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:vico"..v)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:stekr"..v)     
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Text"..v)   
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Photo"..v)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Video"..v)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:File"..v)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Audio"..v)
Redis:del(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:video_note"..v)
Redis:del(Theee_xtr_a.."ee_xtr_a:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n┄─━━ S𝑜𝑢𝑟𝑠𝑒 𝑗𝑎𝑛𝑘𝑒𝑒?? ━━─┄\n"
for k,v in pairs(list) do
if Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:File"..v) then
db = "ملف ✭"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Theee_xtr_a.."ee_xtr_a:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Theee_xtr_a..'ee_xtr_a:GetTexting:DevTheee_xtr_a'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Theee_xtr_a..'ee_xtr_a:Texting:DevTheee_xtr_a')
...
if photo.total_count > 0 then
local TestText = "‹ معلومات المطور الاساسي ›\n\n‹ *الاسم* :›  ["..UserInfo.first_name.."](tg://user?id="..Sudo_Id..")\n\n‹ *البايو* :› ["..Bio.."]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' '..os.date("%Y/%m/%d")..' ', url = "https://t.me/ee_xtr_a"}
...
if text == 'رونالدو' or text == 'اكستراا' or text == 'مبرمج السورس' or text == 'المبرمج اكستراا' then  
local UserId_Info = LuaTele.searchPublicChat("e_xtr_a")
...
local TestText = "- معلومات مبرمج السورس : \\nn‹ *الاسم *:› ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n\n‹ البايو :› ["..Bio.."]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '‹ Ch UseR ›', url = "https://t.me/H_T_S"}
},
{
{text = '𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨', url = "https://t.me/ee_xtr_a"}
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'قناه السورس' or text == 'قناة السورس' or text == '┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄' then
photo = "https://t.me/ee_xtr_a"
local T =[[
W𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜 𝑐ℎ𖤐
]]
keyboard = {} 
...
if text == 'بار رونالدو' or text == 'بار اكسترا' then
photo = "https://t.me/r_o_team"
local T =[[
[┄─━━W𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜 𝑔𝑟𝑢𝑝━━─┄](t.me/r_o_team)
]] 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⇣W𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜 𝑔𝑟𝑢𝑝⇣', url = "https://t.me/r_o_team"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if Redis:get(Theee_xtr_a.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
local rep = msg.id/2097152/0.5
local m = rep +1
...
Redis:del(Theee_xtr_a.."youtube"..msg.sender.user_id..msg_chat_id)
end
if Redis:get(Theee_xtr_a.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = rep +1
https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/youtube7odabot/7951&reply_to_message_id="..rep)
...
return LuaTele.sendText(msg_chat_id,msg_id, "*مـواعـیـد الـصـلاه*\n".."* الفجر〉*"..Fajr.."\n* الظهر〉*"..Dhuhr.."\n* العصر〉*"..Asr.."\n* المغرب〉*"..Maghrib.."\n* العشاء〉*"..Isha.."\n*•━━━━━━━━━━━━━•ٴ*\n* حسب التوقيت المحلي لمدينه القاهره*","md",true)
end
...
{
{text = '⑥', data = msg.sender.user_id..'/NoNextSeting'}, {text = '⑦', data = msg.sender.user_id..'/listallAddorrem'}, 
},
{
{text = '𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨', url = 't.me/ee_xtr_a'}, 
},
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '𝙹𝙰𝙽𝙺𝙴𝙴𝚂',url="https://t.me/ee_xtr_a"}}
}
local msg_id = msg.id/2097152/0.5
...
photo = "https://t.me/ee_xtr_a/1"
local T =[[
⧾ Welcome To Source Extra › 

⧾ Files : [‹ Grup ›](t.me/r_o_team)

⧾ TwisL : [‹ Dev JankEes ›](t.me/ee_xtr_a)

⧾ Channel : [‹ Team JankEes ›](t.me/ee_xtr_a)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
data = {
{
{text = '◐ قـائـمـه الاوامـر', data = msg.sender.user_id..'/helpall'},
},
{
{text = '𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨', url = 't.me/ee_xtr_a'}, 
},
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Name:Bot") 
...
local photo = LuaTele.getUserProfilePhotos(Theee_xtr_a)
local mrt = LuaTele.getUser(Sudo_Id)
local NamesBot = (Redis:get(Theee_xtr_a.."ee_xtr_a:Name:Bot") or "جانكيز")
local BotName = {
...
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(NamesBots).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if text == (Redis:get(Theee_xtr_a.."ee_xtr_a:Name:Bot") or "جانكيز") then
local photo = LuaTele.getUserProfilePhotos(Theee_xtr_a)
local mrt = LuaTele.getUser(Sudo_Id)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
...
local BotName = {
'نعم يروحي 🌝❤️',
'نعم يا قلب 🙈❤️ '..NamesBot..'',
'شلا اشوفك عريس 🌝😹 '..NamesBot..'',
'اي يا وتكه 🌝😹 '..NamesBot..'',
'ايوا ي كلحياتي 🙈❤️',
...
x = x + 1
Redis:srem(Theee_xtr_a..'ee_xtr_a:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Theee_xtr_a)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⧾ البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Theee_xtr_a..'ee_xtr_a:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Theee_xtr_a..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Theee_xtr_a..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Theee_xtr_a..'ee_xtr_a:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Smile"..msg.chat_id,SM)
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Country"..msg.chat_id)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Countrygof"..msg.chat_id,name)
...
if text == "كتبات" or text == "حكمه" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
...
if text == "انصحني" or text == "انصح" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
local texting = {"عامل الناس بأخلاقك ولا بأخلاقهم", 
...
if text == "عايز اضحك" or text == "نكته" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
...
if text == "خيرني" or text == "لو خيروك" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Status:Games"..msg.chat_id) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Difference"..msg.chat_id,name)
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
if text == 'مححح' or text == 'محح' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عيب مش قدام الناس😂🙈*',"md",false, false, false, false, reply_markup)
end

if text == 'وحد الله' or text == 'وحدو الله' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*لا اله الا الله ♥️🌺*',"md",false, false, false, false, reply_markup)
end

if text == 'قول' or text == 'تف' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*صلو على من بكى شوقاً لرؤيتنا ♥️🌺*',"md",false, false, false, false, reply_markup)
end

if text == 'لا اله الا الله' or text == 'لااله الا الله' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*سيدنا محمد رسول الله 😢❤️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*بتعيط لي طيب 😢 😢*',"md",false, false, false, false, reply_markup)
end

if text == 'تم' or text == 'تام' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*تمت فرحتك علي خير 🌚🤤*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*تزحلش بحبق 🥺🥺*',"md",false, false, false, false, reply_markup)
end

if text == 'عععع' or text == 'ععع' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عععععععع😂🌚*',"md",false, false, false, false, reply_markup)
end

if text == 'فل' or text == 'تمام فل' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*فل عليك يقلبي 🌚❤️*',"md",false, false, false, false, reply_markup)
end

if text == 'بقولك' or text == 'بقولك اي' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*قول يروحي 🌚 ❤️*',"md",false, false, false, false, reply_markup)
end

if text == 'ده ابني' or text == 'ابني' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عندو كام سنه ..😹💥*',"md",false, false, false, false, reply_markup)
end

if text == 'يا بنتي' or text == 'بنتي' or text == 'دي بنتي' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*الود كبر وبقي عندو بنت ..😻💥*',"md",false, false, false, false, reply_markup)
end

if text == 'قامده' or text == 'قامد' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*قامد قموده ..🌝♥️*',"md",false, false, false, false, reply_markup)
end

if text == 'ووه' or text == 'وه' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*متبقاش شخص تيلجرامي كدا واستنضف 🙂🚶🎌*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هاا ياروحي*',"md",false, false, false, false, reply_markup)
end

if text == 'يا بت' or text == 'بت' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ليا اسم ياض يعره يمهزء نينينينني😹😎🏃🏻‍♀*',"md",false, false, false, false, reply_markup)
end
...
if text == 'دا بوت' or text == 'ده بوت' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*احيه هو كان مفكرني انسان ولا اي..😹💜*',"md",false, false, false, false, reply_markup)
end

if text == 'قمري' or text == 'قمر' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*انت الي قمر يروحي 🌚❤️*',"md",false, false, false, false, reply_markup)
end

if text == 'انتي مين' or text == 'انت مين' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*انا وحده نسوان ونت مين..😂💘*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*يتي كبرت وبقيت بتشبك الكلام..🥺💘*',"md",false, false, false, false, reply_markup)
end

if text == 'قفل المحن' or text == 'بلاش محن' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*اهلا عزيزي تم قفل المحن بنجاح اتمحونوا بف عشان المراره 😹◉*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*يانوحي يانوحي..🥺💘*',"md",false, false, false, false, reply_markup)
end

if text == 'ههه' or text == 'هه' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ضحكه مش سالكه زيك..😹💘*',"md",false, false, false, false, reply_markup)
end

if text == 'لا عيب' or text == 'عيب' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '𝑺??𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨', url = 't.me/ee_xtr_a'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*سيب الواد يلعب..🙄💛*',"md",false, false, false, false, reply_markup)
end

if text == 'بموت فيك' or text == 'بعشقك' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*بدمنك ياعيوني..🥺💘*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*بالتكت بتعها..🙄💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*يتي القمر زعلان من اي..🥺🔥*',"md",false, false, false, false, reply_markup)
end

if text == 'انت فين' or text == 'فين' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هنا فقلبي..😹♥️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*لا انا شغال متحورش..😒💔*',"md",false, false, false, false, reply_markup)
end

if text == 'انت مين' or text == 'مين' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*انا بوت وبحبك..🥺💘*',"md",false, false, false, false, reply_markup)
end

if text == 'بتعملي اي' or text == 'بتعمل اي' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ونت مالك ياحشري..🙄💘*',"md",false, false, false, false, reply_markup)
end

if text == 'يقلبي' or text == 'قلبي' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*تنشك في قلبك بتخوني..🙄💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*بتضحك علي خيبتك..🙄💘*',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = 'S𝑜𝑢𝑟𝑠𝑒 𝑗𝑎??𝑘𝑒𝑒𝑠', url = 't.me/ee_xtr_a'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*نت هتنكد لي طيب..🥺💔*',"md",false, false, false, false, reply_markup)
end

if text == 'يا نعم' or text == 'نعم' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*مين مؤدب ناوو..😹💘*',"md",false, false, false, false, reply_markup)
end

if text == 'ششش' or text == 'شش' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
if text == 'بتحبني' or text == 'بتحبوني' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*بدمنك ياحبيبي..🥺♥️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*فلخاص بيخصخص..😂💘*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هات لازقه احطها ع بوئي..😹♥️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*دامت ضحكتك يابيبي..🥺💘*',"md",false, false, false, false, reply_markup)
end

if text == 'بكرهك' or text == 'بكرهك' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*لي بس دنا بحبق 🥺💋*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*بتنقط لي ياحزين..🙂💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*كفايه لعب يسطا 😂🤦‍♂*',"md",false, false, false, false, reply_markup)
end

if text == 'منشنلها' or text == 'منشني عليها' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*وااالعه🔥😂*',"md",false, false, false, false, reply_markup)
end

if text == 'تع كول' or text == 'تعالي الكول' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*تع الكول بنوزع سوكولاته😂🌚*',"md",false, false, false, false, reply_markup)
end

if text == 'منشنلو' or text == 'منشن عليه' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
if text == 'منشنيلو' or text == 'منشني عليه' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
if text == 'منشنلها' or text == 'منشن عليها' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*لا مش هي دي..😹🔥*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*تطيب روحك .. ي عيوني 🌸🤍*',"md",false, false, false, false, reply_markup)
end

if text == 'تعداد اد' or text == 'جهاتي' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*كمل يا سالك...🌚😂*',"md",false, false, false, false, reply_markup)
end

if text == 'مين' or text == 'انا مين' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*انت كل حياتي 😂🌚*',"md",false, false, false, false, reply_markup)
end

if text == 'id' or text == 'Id' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*يعم هونت بتفهم عربي عشان تكتبلي انجلش 😂😂*',"md",false, false, false, false, reply_markup)
end

if text == 'صورتي' or text == 'سورتي' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*خطفت قلبي 😢😂🙈*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*جمال عبدالناصر😂🙈*',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = 'S𝑜𝑢𝑟𝑠𝑒 𝑗𝑎𝑛𝑘??𝑒𝑠', url = 't.me/ee_xtr_a'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'*اعدل وشك ونت بتكلمني 😒😒*',"md",false, false, false, false, reply_markup)
end

if text == 'حبك' or text == 'بحبك' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
if text == 'الحمدلله' or text == 'بخير الحمد الله' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
data = {
{
{text = 'S𝑜𝑢𝑟𝑠𝑒 𝑗𝑎𝑛??𝑒𝑒𝑠', url = 't.me/ee_xtr_a'}, 
},
}
}
...
data = {
{
{text = 'S𝑜𝑢𝑟𝑠?? 𝑗𝑎𝑛𝑘𝑒𝑒𝑠', url = 't.me/ee_xtr_a'}, 
},
}
}
...
if text == 'رفع زوجتي' or text == 'زواج' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*خدوني معكو اتفرج 🥺😹*',"md",false, false, false, false, reply_markup)
end

if text == 'مرسي' or text == 'شكرا' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
if text == 'انا جيت' or text == 'جيت' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*نورت يقلبي 🌚❤️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'* امك اسمها اخلاص 😹😹*',"md",false, false, false, false, reply_markup)
end
...
if text == 'تفعيل' or text == 'تفعيلل' then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Sasa:Jeka"..msg_chat_id) then
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return LuaTele.sendText(msg_chat_id,msg_id,'*﷽ آلَلَهّمً ردٍنِآ إلَيَکْ ردٍآ جّمًيَلَآ💔🥺*',"md",false, false, false, false, reply_markup)
end
...
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Theee_xtr_a.."ee_xtr_a:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
local photo = LuaTele.getUserProfilePhotos(Theee_xtr_a)
local ban = LuaTele.getUser(Theee_xtr_a)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(Theee_xtr_a..'ee_xtr_a:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Theee_xtr_a.."ee_xtr_a:Start:Bot") then
...
local CmdStart = '*\n⧾ أهلآ بك في بوت '..(Redis:get(Theee_xtr_a.."ee_xtr_a:Name:Bot") or "جانكيز")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Theee_xtr_a.."ee_xtr_a:Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
{
{text = '┄─━━ 𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨 ━━─┄',type = 'text'},
},
{
{text = 'جلب النسخه الاحتياطيه ⧾',type = 'text'},{text = 'تحديث السورس ⧾',type = 'text'},
},
{
{text = 'السيرفر ⧾',type = 'text'},{text = 'تغير المطور الاساسي ⧾',type = 'text'},
},
{
...
{
{text = 'تغير كليشه ستارت ⧾',type = 'text'},{text = 'حذف كليشه ستارت ⧾', type = 'text'},
},
{
{text = 'الغاء الامر ⧾',type = 'text'},
},
...
Redis:setex(Theee_xtr_a.."ee_xtr_a:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Theee_xtr_a.."ee_xtr_a:Start:Bot") 
...
local Info_Members = Redis:smembers(Theee_xtr_a.."ee_xtr_a:ControllerBot:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⧾ لا يوجد مطورين حاليا , ","md",true)  
end
Redis:del(Theee_xtr_a.."ee_xtr_a:ControllerBot:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"*⧾ تم مسح {"..#Info_Members.."} من المطورين *","md",true)
end
...
if not msg.ControllerBot then
if Redis:get(Theee_xtr_a.."ee_xtr_a:TwaslBot") and not Redis:sismember(Theee_xtr_a.."ee_xtr_a:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Theee_xtr_a.."ee_xtr_a:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Theee_xtr_a.."ee_xtr_a:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Theee_xtr_a..'ee_xtr_a:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⧾ تم حظره من تواصل البوت ').Reply,"md",true)  
end 

if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Theee_xtr_a..'ee_xtr_a:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Theee_xtr_a.."ee_xtr_a:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Theee_xtr_a..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Theee_xtr_a.."ee_xtr_a:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == Theee_xtr_a then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Theee_xtr_a..'ee_xtr_a:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Theee_xtr_a.."ee_xtr_a:Lock:edit"..data.chat_id) then
...
Redis:incrby(Theee_xtr_a.."ee_xtr_a:Num:Add:Games"..ChatId..IdUser, 1)  
...
⧾ ارسل ما تريد تحميله
*]]
Redis:set(Theee_xtr_a.."youtube"..IdUser..ChatId,'mp3')
...
⧾ ارسل ما تريد تحميله
*]]
Redis:set(Theee_xtr_a.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
data = {
{
{text = '◐ الـعـوده', data = IdUser..'/helpall'},
},
}
}
local TextHelp = [[*
...
{
{text = '⑥', data = IdUser..'/NoNextSeting'}, {text = '⑦', data = IdUser..'/listallAddorrem'},
},
{
{text = '𝑺𝑶𝑼𝑹𝑺𝑬 𝑬𝑿𝑻𝑹𝑨', url = 't.me/ee_xtr_a'}, 
},
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
LuaTele.answerCallbackQuery(data.id, "⧾ اوك باي", true)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Theee_xtr_a.."ee_xtr_a:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Theee_xtr_a..'ee_xtr_a:'..lock..UserId[2],"del")    
end
...
{
{text = '◐ اخـفـاء الامـر', data =IdUser..'/'.. 'delAmr'}
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Theee_xtr_a.."ee_xtr_a:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
elseif Text and Text:match('(%d+)/ControllerBot') then
local UserId = Text:match('(%d+)/ControllerBot')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:DevelopersQ:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⧾ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Theee_xtr_a.."ee_xtr_a:SilentGroup:Group"..ChatId) 
